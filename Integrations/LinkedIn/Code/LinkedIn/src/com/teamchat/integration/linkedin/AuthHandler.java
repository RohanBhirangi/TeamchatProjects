...
public class AuthHandler extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if (request.getParameter("oauth_problem") != null) {
			...
			requestLink = new OAuthRequest(Verb.GET,
			...
			if (responseLink.getCode() != 401) {
				...
				api.perform(api
						...
						.post(new PrimaryChatlet()
								.setQuestionHtml("Now you are authorized to send linkedin updates from teamchat"
				...
				request.setAttribute("name", j1.getString("firstName") + " "
